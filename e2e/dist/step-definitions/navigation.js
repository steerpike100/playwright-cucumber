...
var _navigationBehaviour = require("../support/navigation-behaviour");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return (0, _navigationBehaviour.navigateToPage)(page, pageId, globalConfig);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 4;
            return (0, _navigationBehaviour.reloadPage)(page);
